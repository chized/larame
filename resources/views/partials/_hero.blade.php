	...
	<div class="bg-black text-white py-20">
		<div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
			<div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
				...
				<h2 class="text-3xl md:text-5xl leading-relaxed md:leading-snug mb-2">Find remote flexible remote Jobs
				</h2>
				<p class="text-sm md:text-base text-gray-50 mb-4">Explore opportunites, internships and jobs for women and care-givers returning to the work space
                    		register now to recieve updates and showcase your skills and talent.</p>
				<a href="#"
